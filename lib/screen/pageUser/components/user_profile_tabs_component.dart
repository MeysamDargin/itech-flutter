...
class UserProfileTabsComponent extends StatefulWidget {
  final List<String> tabs;
  final int selectedTabIndex;
  final Function(int) onTabSelected;

  const UserProfileTabsComponent({
    Key? key,
    required this.tabs,
  ...
  @override
  State<UserProfileTabsComponent> createState() =>
      _UserProfileTabsComponentState();
}

class _UserProfileTabsComponentState extends State<UserProfileTabsComponent> {
  @override
