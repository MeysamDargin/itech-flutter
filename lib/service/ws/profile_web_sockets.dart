...
class ProfileSocketService {
  ...
  Future<void> connectToWebSocket(
    ...
    final wsUrl = "${ApiAddress.baseUrlSW}ws/ChengProfiles/";
  ...
  void _sendInitialMessage() {
    if (_channel != null && _isConnected) {
      final initialMessage = {'type': 'init', 'action': 'get_profile'};
...
class UserSocketService {
  ...
  Future<void> connectToWebSocket(
    ...
    final wsUrl = "${ApiAddress.baseUrlSW}ws/ChengUsers/";
  ...
  void _sendInitialMessage() {
    if (_channel != null && _isConnected) {
      final initialMessage = {'type': 'init', 'action': 'get_user_data'};
      _channel!.sink.add(jsonEncode(initialMessage));
    }
  }
