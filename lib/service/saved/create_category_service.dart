...
class CreateCategoryService {
  final String _baseUrl =
      '${ApiAddress.baseUrl}${ApiEndpoint.createSaveDirectory}';
  final LoginService _loginService = LoginService();

  Future<Map<String, dynamic>?> createSaveDirectory({
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        print(
          'Failed to create save directory: ${response.statusCode} - ${response.body}',
        );
